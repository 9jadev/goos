...
$(".h-block").css("display", "none");
$(".copy.text-right").html("");
$(".copy.text-right").append('<a id="to-top" href="#this-is-top"><i class="fa fa-chevron-up"></i></a>© 2018 <a href="#"> Trans Cargo Ltd.   </a>- All rights reserved.');
$(".text-right.header-padding a.btn.btn-success").html("");
$(".text-right.header-padding a.btn.btn-success").attr("href", "tracking_trace.htm");
$(".text-right.header-padding a.btn.btn-success").html("TRACK");
