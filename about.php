...
<html>
	<head>
		<meta charset="utf-8">
		<meta http-equiv="description" content="About  -"><meta name="viewport" content="width=device-width, initial-scale=1">
		<title> About  -  Trans Cargo Ltd.  </title>
		<style type="text/css">
  ...
  new google.translate.TranslateElement({pageLanguage: 'en', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
			...
			<div class="bg-image page-title">
				<div class="container-fluid">
					...
					<div class="pull-right">
						<a href="01_home.php"><i class="fa fa-home fa-lg"></i></a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href="03_about.php">About Us</a>
					</div>
				</div>
			</div>
			...
			<div class="bg-image parallax" style="background-image:url(media/bg/4.jpg);">
				<div class="container-fluid text-center wow fadeInUp" data-wow-delay="0.3s">
					...
					<a class="btn btn-success" href="blog.php">READ MORE</a>
				</div>
			</div>
			...
			<div class="container-fluid block-content inner-offset">
				...
				<div class="row main-grid team hover-eff">
					<div class="col-sm-4 wow fadeInLeft" data-wow-delay="0.3s">
						<div class="userpic" style="background-image:url(media/our-team/1.jpg);">
							<span>Umut has over twenty years experience and is one of the most senior commentators on industry issues. His professional experience has been gained within market leading and multi-national companies.
							Metin is married with two adult children.</span>
						</div>
						<div class="user-info">
							<small>Managing Director</small>
							<h4>UMUT SAVAS</h4>
						</div>
						<a href="mailto:metinsoner@transcargo.info " class="btn btn-sm btn-success">SEND EMAIL</a>
						
					</div>
					<div class="col-sm-4 wow fadeInUp" data-wow-delay="0.3s">
						<div class="userpic" style="background-image:url(media/our-team/2.jpg);">
							<span>Metin joined  Trans Cargo Ltd.   in june, 2008. Umut has a wealth of knowledge about the parcel delivery sector and over the last 25 years has held a number of senior management
							Her focus will be to expand CSL service options to improve our clients’ supply chain, helping them meet the needs of their customers.</span>
						</div>
						<div class="user-info">
							<small>Dispatch Team Manager</small>
							<h4>METIN SONER</h4>
						</div>
						<a href="mailto:umutsavas@transcargo.info " class="btn btn-sm btn-success">SEND EMAIL</a>
					</div>
					<div class="col-sm-4 wow fadeInRight" data-wow-delay="0.3s">
						<div class="userpic" style="background-image:url(media/our-team/3.jpg);">
							<span>Deniz Erol, Chief Operating Officer, joined CSL in September, 2008. He served in senior distribution and logistics operating roles in a variety of industries including food distribution, beverage supply chain, and oil & gas distribution.
							Deniz’s background includes the design, development and operation of several regional and national distribution networks. Deniz started his career as a production engineer in the mid-1980s.</span>
						</div>
						<div class="user-info">
							<small>Database Administrator</small>
							<h4>DENIZ EROL</h4>
						</div>
						<a href="mailto:denizerol@transcargo.info " class="btn btn-sm btn-success">SEND EMAIL</a>
					</div>
				</div>
			</div>       
			...
			<div class="darken-block inner-offset">
				<div class="container-fluid">
					<div class="hgroup">
						<h1>HAPPY CLIENTS</h1>
						<h2>CSL customers rave about our industry-leading service and support!</h2>
					</div>
					<div id="testimonials2" class="owl-carousel enable-owl-carousel" data-pagination="false" data-navigation="true" data-auto-play="true" data-min450="1" data-min600="2" data-min768="2">
						<div>
							<div class="testimonial-content">
								...
								<p>I received my latest package and was pleasantly surprised to find a handwritten note.
								The packages have always been neatly stacked and over last few years MyUS has never given me occasion to complain. Keep it up.</p>
							</div>
						...
						<div>
							<div class="testimonial-content">
								<span><i class="fa fa-quote-left"></i></span>
								<p>The packages have always been neatly stacked and over last few years CSL has never given me occasion to complain. Keep it up. This is the best service ever…can't wait to give a 5 star rating. Thanks.</p>
							</div>
							<div class="text-right testimonial-author">
								<h4>KATE</h4>
							</div>
						...
						<div>
							<div class="testimonial-content">
								<span><i class="fa fa-quote-left"></i></span>
								<p>I was a bit skeptical at first but I received my order 2 days before the scheduled delivery date. I am so happy I found an easy way to buy and ship stuff from the US directly to my doorstep. I advise everyone to use CSL. </p>
							</div>
							<div class="text-right testimonial-author">
								<h4>CLARK</h4>
							</div>
						...
						<div>
							<div class="testimonial-content">
								<span><i class="fa fa-quote-left"></i></span>
								<p>Professional, friendly and reliable; nothing is too much trouble for CSL Couriers. Whether it is getting urgent parts out to waiting engineers or cost effective overnight product shipment they make it simple. I woudn't use any one else.</p>
							</div>
							<div class="text-right testimonial-author">
								<h4>ADEM</h4>
							</div>
						...
						<div>
							<div class="testimonial-content">
								<span><i class="fa fa-quote-left"></i></span>
								<p>Reliable couriers - what more could you ask for? Fast efficient, friendly and cost effective.</p>
							</div>
							<div class="text-right testimonial-author">
								<h4>BERKER</h4>
							</div>
						...
						<div>
							<div class="testimonial-content">
								<span><i class="fa fa-quote-left"></i></span>
								<p>I received a package today from CSL and was very happy with the service. It took less than 4 days and the quality of packaging was exceptional. </p>
							</div>
							<div class="text-right testimonial-author">
								<h4>JUAN</h4>
							</div>
			...
			<div class="container-fluid partners block-content">
				<div class="hgroup title-space wow fadeInLeft" data-wow-delay="0.3s">
					...
					<h2> Trans Cargo Ltd.   has leveraged on her Global Partnership<br> to maintain a global reach to meet our customers’ needs in every facets<br> of providing logistics service.</h2>
				</div>
